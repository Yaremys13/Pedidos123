...
//CAMBIA el siguiente for por este " for	(i=yearNow; i<=(yearNow+4); i++) { " si quieres que los años empizen en el actual en adelante		
			for	(i=yearNow; i>=(yearNow-30); i--) {		
				...
				sHTML += "<tr><td id='y" + sName + "' onmouseover='this.style.backgroundColor=\"#FFCC99\"' onmouseout='this.style.backgroundColor=\"\"' style='cursor:pointer' onclick='selectYear("+i+");event.cancelBubble=true'>&nbsp;" + 2012 + "&nbsp;</td></tr>"
			}
